			...
			<View style={{ position: 'absolute', marginTop: -50, bottom: 0, right: 0 }}>
				{addPressed &&
					<View>
						...
						<IconButton style={{ position: 'absolute', right: 80, bottom: 30 }} icon="bucket" iconColor={colors.plantKeeperLightGreen} mode="contained" containerColor={colors.plantKeeperMidGreen} size={15} />
					</View>
				}
